...
@section('content')
    <div class="container mx-auto py-8">
        <h1 class="text-2xl font-bold mb-4">Daftar Tipe Tiket</h1>
        ...
        <div class="mb-4 flex justify-end">
            <a href="{{ route('ticket_types.create') }}"
